        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              Column(
                children: [
                  const TSectionHeader(title: 'Profile information')
                      .withPadding(TSizes.spaceBtwItems.bottomPadding),
                  TProfileMenuTile(
                      title: 'name',
                      subTitle: controller.userModel.value.firstName),
                  TProfileMenuTile(
                      title: 'username',
                      subTitle: controller.userModel.value.lastName),
                ],
              ),
              ...
              Column(
                children: [
                  ...
                  TProfileMenuTile(
                      title: 'UserID',
                      subTitle: controller.userModel.value.id,
                  ...
                  TProfileMenuTile(
                      title: 'phone number',
                      subTitle: controller.userModel.value.phoneNumber),
                  const TProfileMenuTile(title: 'Gender', subTitle: 'Male'),
                  const TProfileMenuTile(
                      title: 'Date of Birth', subTitle: '04 Sept. 1990'),
                ],
              ),
