...
class _DatePickerDialogState extends State<DatePickerDialog>
  ...
  Widget build(BuildContext context) {
    ...
    custom_calendar_date_picker.CalendarDatePicker calendarDatePicker() {
      // Custom change
      return custom_calendar_date_picker.CalendarDatePicker(
        // Custom change
            ...
            child: Column(
              children: <Widget>[
                ...
                CustomDateField(
                  ...
                  controlWidget: custom_input_date_picker_form_field
      ...
      case DatePickerEntryMode.calendarOnly:
        contents = _CalendarRangePickerDialog(
          ...
          entryModeButton: showEntryModeButton
              ? IconButton(
                  icon:
                      const FaIcon(FontAwesomeIcons.lifeRing), // Custom change
      ...
      case DatePickerEntryMode.inputOnly:
        contents = _InputDateRangePickerDialog(
          ...
          entryModeButton: showEntryModeButton
              ? IconButton(
                  icon:
                      const FaIcon(FontAwesomeIcons.calendar), // Custom change
                  padding: EdgeInsets.zero,
                  tooltip: localizations.calendarModeButtonLabel,
                  onPressed: _handleEntryModeToggle,
                )
      ...
      children: <Widget>[
        Container(
          padding: EdgeInsets.symmetric(
              horizontal: context.screenWidth * 0.065), // Custom change
