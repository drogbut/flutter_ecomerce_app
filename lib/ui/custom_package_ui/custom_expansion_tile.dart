...
class ExpansionTileController {
  ...
  // Check if _state is null // Custom change
  bool get isStateNotNull {
    // Custom change
    return _state != null; // Custom change
  } // Custom change
...
class ExpansionTile extends StatefulWidget {
  ...
  /// When not null, defines the dense of the list tile.
  final bool? dense; // Custom new
  ...
  Widget? _buildIcon(BuildContext context) {
    return Padding(
      ...
      padding: EdgeInsets.only(
        // Custom change
        left: _effectiveAffinity(widget.controlAffinity) == ListTileControlAffinity.leading ? 10 : 0, // Custom change
        right: _effectiveAffinity(widget.controlAffinity) == ListTileControlAffinity.trailing ? 10 : 0, // Custom change
      ), // Custom change
      child: RotationTransition(
        // Custom change
        turns: _iconTurns, // Custom change
        child: const FaIcon(
          // Custom change
          FontAwesomeIcons.lightChevronDown, // Custom change
        ), // Custom change
      ), // Custom change
    ); // Custom change
  }
