...
import '../my_appbar/platform_back_button.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return AlertDialog(
      ...
      actions: <Widget>[
        ...
        TextButton(
          child: Text(
              themeData.useMaterial3 ? localizations.closeButtonLabel : localizations.closeButtonLabel.toUpperCase()),
          onPressed: () {
              ...
              case ConnectionState.done:
                ...
                return ValueListenableBuilder<int?>(
                  ...
                  builder: (BuildContext context, int? selectedId, Widget? _) {
                    return Center(
                      child: Material(
                        color: Theme.of(context).scaffoldBackgroundColor, // Custom change
                        elevation: 4.0,
                        child: Container(
...
class _PackageListTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Ink(
      color: isSelected ? Theme.of(context).highlightColor : Theme.of(context).scaffoldBackgroundColor, // Custom change
      child: ListTile(
...
class _PackageLicensePageState extends State<_PackageLicensePage> {
  ...
  Widget build(BuildContext context) {
    ...
    if (widget.scrollController == null) {
      page = Scaffold(
        appBar: AppBar(
          leading: const MyAppBarBackButton(), // Custom new
          automaticallyImplyLeading: true, // Custom new
        ...
        body: Center(
          child: Material(
            color: theme.scaffoldBackgroundColor, // Custom change
            elevation: 4.0,
            child: Container(
              constraints: BoxConstraints.loose(const Size.fromWidth(600.0)),
      ...
      page = CustomScrollView(
        ...
        slivers: <Widget>[
          SliverAppBar(
            ...
            pinned: true,
            backgroundColor: theme.scaffoldBackgroundColor, // Custom change
            title: _PackageLicensePageTitle(
              title: title,
              subtitle: subtitle,
...
class _PackageLicensePageTitle extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final Color color = Theme.of(context).colorScheme.primary; // Custom change
        ...
        return BlockSemantics(
          child: _MasterPage(
            leading: widget.automaticallyImplyLeading && Navigator.of(context).canPop()
                ? MyAppBarBackButton(onPressed: () => Navigator.of(context).pop()) // Custom change
                : null,
            title: widget.title,
            automaticallyImplyLeading: true, // Custom change
