...
class _DatePickerModeToggleButtonState extends State<_DatePickerModeToggleButton> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    final Color controlColor = Theme.of(context).primaryColor; // Custom change
                      ...
                      children: <Widget>[
                        ...
                        Padding(
                          ...
                          padding: const EdgeInsets.only(
                            // Custom change
                            left: 15, // Custom change
                          ), // Custom change
                          child: RotationTransition(
                            // Custom change
                            turns: _controller, // Custom change
                            child: FaIcon(
                              // Custom change
                              FontAwesomeIcons.chevronDown, // Custom change
                              color: controlColor, // Custom change
                              size: 16, // Custom change
                            ), // Custom change
                          ), // Custom change
                        ), // Custom change
                      ],
            ...
            child: Row(
              children: <Widget>[
                ...
                IconButton(
                  icon: FaIcon(
                    // Custom change
                    FontAwesomeIcons.chevronLeft, // Custom change
                    color: Theme.of(context).primaryColor, // Custom change
                    size: 16, // Custom change
                  ), // Custom change
                  color: controlColor,
                ...
                IconButton(
                  icon: FaIcon(
                    // Custom change
                    FontAwesomeIcons.chevronRight, // Custom change
                    color: Theme.of(context).primaryColor, // Custom change
                    size: 16, // Custom change
                  ), // Custom change
                  color: controlColor,
